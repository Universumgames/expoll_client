<template>
    <router-link :to="'/polls/' + poll.pollID" class="pollListElementContainer">
        <div>
            ...
            <br>
            <small v-show="!poll.editable" class="delete" style="padding: 0.5ch; border-radius: 0.5rem">
        ...
        <div>
            ...
            <svg
                fill="var(--text-color)" style="width: 5ch; height: 5ch;"
                viewBox="0 0 24 24"
        ...
        <div>
            ...
            <small v-else>{{ lastUpdated }}</small>
        </div>
